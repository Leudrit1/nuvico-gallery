    ...
    <footer className="bg-charcoal text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-100 hover:text-warm-brown transition-colors">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-200 text-sm">© 2024 NUVICO. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <a href="#" className="text-gray-200 hover:text-warm-brown text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-200 hover:text-warm-brown text-sm transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-200 hover:text-warm-brown text-sm transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
